...
Profiling includes the initial "pre-run" processing of certain lines (DATA, FILES, DEF FN, and END) and the regular processing of all lines.
The END statement is processed in both "pre-run" mode (to ensure that it is the last statement in a program) and often in regular mode (to stop processing).
