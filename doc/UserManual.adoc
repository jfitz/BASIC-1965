...
The BREAK option includes breakpoints in the file.
...
|WARN_LIST_WIDTH |N |numeric 0 to 132 |72 |Sets the limit for program lines as shown by LIST; 0 disables warnings
|WARN_PRETTY_WIDTH |N |numeric 0 to 132 |72 |Sets the limit for program lines as shown by PRETTY; 0 disables warnings
