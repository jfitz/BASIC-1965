...
|FORGET_FORNEXT |TRUE or FALSE |FALSE |Forgets value of control value after final NEXT, if value was not defined at start
...
|MATCH_FORNEXT | TRUE or FALSE |FALSE |Requires execution of NEXT to match FOR
|NEWLINE_SPEED |numeric |0 |Limit printing speed only for newlines
|PRECISION |numeric 1 to 16, or "INFINITE" |6 |Sets the precision for numeric values
