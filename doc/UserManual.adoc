...
|--precision |Sets the precision for numeric variables. Default is 7, maximum is 16.
...
|PRECISION |numeric 1 to 16 |7 |Sets the precision for numeric values
...
|CON or CON() |Creates an array or matrix containins all ones, with dimensions based on the assignment target.
...
|ZER or ZER() |Creates an array or matrix containins all zeros, with dimensions based on the assignment target.
|===========
