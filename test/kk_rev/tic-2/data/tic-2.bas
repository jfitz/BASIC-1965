...
490     IF P = 0 THEN 530
500     LET C(P) = C(P) + F
510     IF C(P) <> -3 THEN 520
511     LET J0 = 1
512     BREAK
520     IF C(P) <> 3 THEN 530
521     LET J0 = 2
522     BREAK
530  NEXT J
531  IF J0 = 1 THEN 860
532  IF J0 = 2 THEN 800
535  LET N = N+1
536  IF N = 9 THEN 880
537  IF F = 1 THEN 400
538  GOTO 600
...
1010 FOR P = 1 TO 8
1020 IF C(P) <> 2 THEN 1030
1029 BREAK
1030 NEXT P
1031 IF BROKEN() THEN 1100
1040 FOR P = 1 TO 8
1050 IF C(P) <> -2 THEN 1060
1059 BREAK
1060 NEXT P
1061 IF BROKEN() THEN 1100
1070 GOTO 1200
1100 FOR I = 1 TO 3
1110    LET M = T(P,I)
1120    IF B(M) <> 0 THEN 1130
1129    BREAK
1130 NEXT I
1132 IF BROKEN() THEN 1390
1140
1200 FOR S = 1 TO 9
1210    LET V(S) = 0
