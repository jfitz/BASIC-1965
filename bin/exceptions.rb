...
$error_codes = {
  ...
  te_var_no_lock: 134,
  te_arr_dim_lock: 135,
  te_arr_dim_no_lock: 136,
  te_mat_dim_lock: 137,
  te_mat_dim_no_lock: 138,
  te_ret_no_gos: 140,
  te_fname_inv: 150,
  te_file_no_fnd: 151,
  te_fh_unk: 152,
...
$error_messages = {
  ...
  te_arr_dim_lock: 'Array dimensions are locked',
  te_arr_dim_no_lock: 'Array dimensions are not locked',
  te_mat_dim_lock: 'Matrix dimensions are locked',
  te_mat_dim_no_lock: 'Matrix dimensions are not locked',
  ...
  te_option_lock: 'Option is locked',
